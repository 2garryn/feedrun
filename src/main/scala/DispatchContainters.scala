...
trait DispatchContainerStage1 extends DispatchContainer {
  val actor: String
...
case class DispatchAddActivityStage1(actor: String, targetFeed: String, activity: Activity) extends DispatchContainerStage1
...
case class DispatchDeleteActivityStage1(actor: String, targetFeed: String, activity: Activity) extends DispatchContainerStage1
